            ...
            var vm = new SmartPageViewModel
            {
                ...
                Charts = new SmartChartsConfig
                {
                    Cards = new List<ChartCardConfig>
                    {
                        ...
                        {
                            Type = ChartCardType.HealthKpiAnnual,
                            Title = "مؤشر أداء المدن العسكرية للتشغيل والصيانة",
                            Subtitle = "خطة مستهدفات المدن الصحية للتشغيل والصيانة(آخر 90 يوم)",
                            ...
                            HealthKpiIndicators = new List<HealthKpiIndicator>
                            {
                                ...
                                {
                                    Key = "kpi1",
                                    Title = "نسبة اشغال المساكن",
                                    Subtitle = "اخر 90 يوما",
                                    Unit = "مشارك",
                                    Emoji = "🏘️",
                                    Icon = "fa-solid fa-person-walking",
                                    Tone = "info",
                                    PlanGoal = 2221,
                                    Hint = "مستهدف خلا 90 يوما.",
                                ...
                                {
                                    Key="kpi2",
                                    Title="التحصيل المالي للايجارات والخدمات",
                                    Subtitle="هدف نهائي: 90% ",
                                    Unit="%",
                                    Emoji="💵",
                                    Icon="fa-solid fa-bicycle",
                                    Tone="success",
                                ...
                                {
                                    Key="kpi3",
                                    Title="اغلاق البلاغات واوامر العمل",
                                    Subtitle="هدف نهائي: 95%",
                                    Unit="%",
                                    Emoji="📞",
                                    Icon="fa-solid fa-ban-smoking",
                                    Tone="danger",
