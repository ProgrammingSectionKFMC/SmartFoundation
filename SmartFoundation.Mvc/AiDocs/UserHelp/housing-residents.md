...
ملاحظة: البحث يعتمد على أول مجموعة حقول سريعة من الجدول .

---

## إضافة مستفيد
(يظهر زر الإضافة فقط إذا لديك صلاحية)
...
## تعديل مستفيد
(يظهر زر التعديل فقط إذا لديك صلاحية)
...
ملاحظات:
- رقم الهوية في التعديل يكون للعرض/غير قابل للتعديل الا اذا كنت تملك صلاحية.
- يجب تحديد صف واحد فقط .
...
1) اضغط **طباعة تقرير**.
2) يتم توليد PDF  ويعرض التقرير داخل المتصفح .
...
### كيف أضيف مستفيد؟
من زر إضافة مستفيد ثم تعبئة البيانات.

### لماذا لا يظهر زر الإضافة؟
بسبب الصلاحيات.

### لماذا لا يعمل التعديل؟
يجب تحديد صف واحد فقط.
